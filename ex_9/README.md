...
W archiwum załączonym do tego zadania znajdziesz implementację [gry w życie Conway-a](https://en.wikipedia.org/wiki/Conway%27s_Game_of_Life). Na podstawie tego kodu wykonaj poniższe zadanie:
